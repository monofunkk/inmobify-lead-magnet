  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <div className="relative z-10">
        ...
        {/* Main Content - Properly centered with safe areas */}
        <div className="pt-16 md:pt-20 pb-safe-area-inset-bottom">
          {/* VSL Section - Centered and responsive */}
          <VSLSection onCTAClick={() => setIsFormPopupOpen(true)} />

          {/* Pain Points Section */}
          <section className="py-8 md:py-12 lg:py-20 px-3 safe-area-px fade-in-section">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                <Card className="bg-destructive/5 backdrop-blur-sm border-destructive/20 hover:scale-105 transition-transform duration-200 min-h-[200px] flex flex-col">
          ...
          {/* Solution Section */}
          <section className="py-8 md:py-12 lg:py-20 px-3 safe-area-px bg-card/30 fade-in-section">
            <div className="max-w-6xl mx-auto text-center">
              <h2 className="text-xl md:text-2xl lg:text-4xl font-bold mb-2 md:mb-3 lg:mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                <Card className="bg-card/50 backdrop-blur-sm border-border/50 hover:scale-105 transition-transform duration-200 min-h-[200px] flex flex-col">
                  <CardContent className="p-4 md:p-6 flex-1 flex flex-col justify-center">
          ...
          <section className="py-12 md:py-16 lg:py-20 px-3 safe-area-px fade-in-section">
          ...
          <section className="py-12 md:py-16 lg:py-20 px-3 safe-area-px bg-card/30 fade-in-section">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
                ...
                <div className="flex-1 text-center lg:text-left animate-fade-in-delay-1">
                  ...
                  <Button 
                    ...
                    size="lg" 
                    className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 md:px-6 lg:px-8 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 text-sm md:text-base lg:text-lg font-bold w-full max-w-xs md:max-w-sm mx-auto lg:mx-0 h-12 min-h-[44px]"
                  >
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="mt-8 md:mt-12">
                <Button 
                  onClick={() => setIsFormPopupOpen(true)} 
                  size="lg" 
                  className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 md:px-6 lg:px-8 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 text-sm md:text-base lg:text-lg font-bold w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto h-12 min-h-[44px]"
                >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1" className="bg-card/50 backdrop-blur-sm border-border/50 rounded-lg px-4 md:px-6">
                  <AccordionTrigger className="text-left hover:text-primary text-sm md:text-base min-h-[44px]">
          ...
          {/* Value Stack Section */}
          <section className="py-12 md:py-16 lg:py-20 px-3 safe-area-px bg-primary/10 fade-in-section">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8 md:mb-12">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">
              ...
              <div className="text-center mb-4 md:mb-6">
                <Button 
                  onClick={() => setIsFormPopupOpen(true)} 
                  size="lg" 
                  className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 md:px-6 lg:px-8 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 text-sm md:text-base lg:text-lg font-bold mb-3 md:mb-4 w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto h-12 min-h-[44px]"
                >
          ...
          <footer className="py-6 md:py-8 lg:py-12 px-3 safe-area-px border-t border-border/50">
            <div className="max-w-6xl mx-auto">
              {/* Investment Image */}
              <div className="text-center mb-6 md:mb-8">
