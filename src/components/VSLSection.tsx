...
const VSLSection: React.FC<VSLSectionProps> = ({
  ...
  return <section className="py-12 md:py-16 lg:py-20 px-3 fade-in-section rounded-none">
        ...
        <Card className="bg-card/50 backdrop-blur-sm border-border/50 mb-6 md:mb-8">
          <CardContent className="p-4 md:p-6 lg:p-8">
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg mb-6">
              <wistia-player media-id="77cc5muon3" aspect="1.7777777777777777" />
            </div>
            ...
            <div className="text-center">
              ...
              {/* CTA Button */}
              <Button onClick={onCTAClick} size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 md:px-6 lg:px-8 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 text-sm md:text-base lg:text-lg font-bold w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto h-12 md:h-14">
